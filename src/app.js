import "../index.css"; // Adjust the path based on location
...
//   if (!resData?.data) return null; // Prevents errors if resData is missing

//   const {
//     cloudinaryImageId,
//     name,
//     avgRating,
//     cuisines = [], // Default to empty array
//     costForTwo,
//     deliveryTime,
//   } = resData.data; // No need for optional chaining after check
...
//       <h4>₹{costForTwo ? costForTwo / 100 : "N/A"} FOR TWO</h4>
//       <h4>{deliveryTime ? `${deliveryTime} minutes` : "Delivery time not available"}</h4>
//     </div>
//   );
// };
